...
locals {
  ...
  azurerm_management_group_assignments = [
      ...
      },
      {
          ...
          policy_definition_id = "/providers/Microsoft.Management/managementGroups/matthew-lz-canary/providers/Microsoft.Authorization/policySetDefinitions/12794019-7a00-42cf-95c2-882eed337cc8"
          management_group_id  = "/providers/Microsoft.Management/managementGroups/4f8875af-ac0b-46ee-8a73-3634138f5818"
          parameters = jsonencode(merge({}))
          identity_type = ["UserAssigned"]
          identity_ids = [local.resource_ids.userAssignedIdentity]
      ...
      },
      {
          ...
          policy_definition_id = "/providers/Microsoft.Management/managementGroups/matthew-lz-canary/providers/Microsoft.Authorization/policyDefinitions/88c0b9da-ce96-4b03-9635-f29a937e2900"
          management_group_id  = "/providers/Microsoft.Management/managementGroups/matthew-lz-canary-landing-zones"
          parameters = jsonencode(merge({}))
          identity_type = []
      },
